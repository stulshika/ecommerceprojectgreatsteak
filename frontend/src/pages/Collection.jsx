...
const Collection = () => {
    ...
    const toggleSubCategory = (e) => {
        if (subCategory.includes(e.target.value)) { // ✅ Fixed typo
    ...
    const sortProduct = () => {
        let fpCopy = [...filterProducts]; // ✅ Ensures we don't mutate the state directly
    ...
    return (
        <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
            ...
            <div className='flex-1'>
                <div className='flex justify-between text-base sm:text-2xl mb-4'> {/* ✅ Fixed `text-2x1` */}
